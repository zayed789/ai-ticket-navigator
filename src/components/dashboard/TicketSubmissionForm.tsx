          ...
          <div className="w-full max-w-md rounded-lg border border-border bg-background p-4 text-left space-y-3">
            ...
            <div className="flex items-center justify-between border-b border-border pb-3">
              ...
              <span className={cn(
                ...
                submittedTicket.urgency === 'Urgent' ? "bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400" :
                submittedTicket.urgency === 'High' ? "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400" :
                submittedTicket.urgency === 'Normal' ? "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400" :
