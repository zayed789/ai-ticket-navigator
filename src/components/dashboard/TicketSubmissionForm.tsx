          ...
          <div className="w-full max-w-md rounded-lg border border-border bg-background p-4 text-left space-y-3">
            ...
            <div className="flex items-center justify-between border-b border-border pb-3">
              ...
              <span className={cn(
                ...
                submittedTicket.urgency === 'Critical' ? "bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400" :
                submittedTicket.urgency === 'High' ? "bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400" :
                submittedTicket.urgency === 'Medium' ? "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400" :
                submittedTicket.urgency === 'Low' ? "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400" :
            ...
            <div className="flex items-center justify-between border-b border-border pb-3">
              ...
              <span className={cn(
                "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium",
                submittedTicket.priority === 'P1' ? "bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400" :
                submittedTicket.priority === 'P2' ? "bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400" :
                submittedTicket.priority === 'P3' ? "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400" :
                submittedTicket.priority === 'P4' ? "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400" :
                "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300"
              )}>
            ...
            <div className="flex items-center justify-between border-b border-border pb-3">
              <span className="text-sm font-medium text-muted-foreground">Assigned Team</span>
              <span className="text-sm text-foreground">{submittedTicket.assigned_team || ''}</span>
            </div>
